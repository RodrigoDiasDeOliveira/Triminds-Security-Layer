...
public class WebFiltersConfig {
    ...
    FilterRegistrationBean<CorrelationIdFilter> correlationId() {
        var b = new FilterRegistrationBean<>(new CorrelationIdFilter());
        b.setOrder(1);
        return b;
    }

    @Bean
    FilterRegistrationBean<TenantResolverFilter> tenant() {
        var b = new FilterRegistrationBean<>(new TenantResolverFilter());
        b.setOrder(2);
        return b;
    }
}